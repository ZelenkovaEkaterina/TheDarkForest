...
public class ProjectilePool<T> where T : MonoBehaviour
{
    ...
    public ProjectilePool(T prefab, int initializeSize, Transform parent = null, Func<T, T> factoryOverride = null)
    {
        _prefab = prefab;
        _parent = parent;
